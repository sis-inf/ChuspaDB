...
Este documento describe las funcionalidades actuales y las planificadas para futuras versiones del proyecto.

## Motores soportados

| Funcionalidad | Estado | Prioridad | Dificultad |
|--------------|---------|------------|------------|
| MySQL | Implementado | Alta | Media |
| SQLite | Implementado | Alta | Baja |
| PostgreSQL | Implementado | Alta | Media |
| Oracle | Planificado | Media | Alta |
...
| Funcionalidad | Estado | Prioridad | Dificultad |
|--------------|---------|------------|------------|
| Historial | Implementado | Alta | Media |
